    ...
    <div className="min-h-screen font-golos" style={{ background: 'var(--color-bg)', color: 'var(--color-text)' }}>
      ...
      <section className="hero-bg relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-1/2 right-0 -translate-y-1/2 w-[520px] h-[520px] rounded-full blur-3xl" style={{ background: 'rgba(142,59,158,0.10)', transform: 'translate(15%, -50%)' }} />
        </div>
